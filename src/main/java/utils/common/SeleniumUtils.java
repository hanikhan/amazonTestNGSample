...
public class SeleniumUtils {
    ...
    public boolean isVisible(WebpageElements elementDetails,int timeout){
		/*
		 * This function is to check the visibility of the element.
		 */
        boolean flagValue=false;
    ...
    public List<WebElement> findElements(WebpageElements elementDetails){
		/*
		 * This function is the add on for selenium findElement method.
		 */
        List<WebElement> elements=null;
        try{
            elements=driver.findElements(By.xpath(elementDetails.getElementIdentifier()));
        }
        catch(Exception e){
            throw new RuntimeException(elementDetails.getElementName()+" not found in the page.");
        }
    ...
    public void checkIfPageLoadCompleted(int timeout){
